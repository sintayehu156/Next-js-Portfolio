...
const Navbar = () => {
  ...
  useEffect(() => {
    if (
      ...
      router.asPath === '/kenema' ||
      router.asPath === '/bizenforce' ||
      router.asPath === '/techethio'
    ) {
  ...
  return (
    ...
    >
      ...
      <div
        className={
          nav ? "md:hidden flex left-0 top-0 w-full h-screen bg-gray-800" : ""
        }
      >
        <div
          className={
          ...
          <div>
            ...
            <div className="border-b border-gray-300 my-4">
              <p className="w-[85%] md:w-[90%] py-4 ">
                Let`s built Something legendary together{" "}
              </p>
            </div>
          </div>
          <div>
